...
The first three files are mendetory for the Scorpion  scanner. These files have the list of files and directories which the scanner uses for crawling.
